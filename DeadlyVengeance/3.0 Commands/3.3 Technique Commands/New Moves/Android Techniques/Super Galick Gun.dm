...
mob
	proc
		Super_Galick_Gun_Shoot()
			var/obj/tech/H = new/obj/tech/www6(o=src)
			H.ki_damage = round(src.powerlevel_max * 0.80)
								...
								if(M.ki_shield)
									...
									if(M.absorbing)
										if(absorb_max > H.ki_damage)
											...
											return
										else M << "\red You tried to absorb [src]'s Super Galick Gun, but it was too strong!"
